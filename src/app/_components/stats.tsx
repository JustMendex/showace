...
export function Charts() {
    return (
        <div className="chart-wrapper flex w-full flex-col flex-wrap items-start justify-center gap-6  sm:flex-row p-4">
            ...
            <div className="grid w-full gap-6 sm:grid-cols-2  lg:grid-cols-1 lg:max-w-[40rem]">
                <Card
            ...
            <div className="grid w-full flex-1 gap-6 xl:max-w-[32rem]">
                <Card
